...
<div class="section no-pad">
    ...
    <div class="section container" id="tech">
        <div class="row">
            <div class="col s12 m12">
                <?php require 'php/resumetable.php'; ?>
            </div>
        </div>
    </div>

    <div class="section container" id="acc-edu">
        <div class="row">
            <div class="col s12 m6">
                <h3 class="header">Accolades</h3>
                <div class="card">
                    <div class="card-image">
                        <img src="resources/img/mecapstone.jpg">
                    </div>
                    <div class="card-content">
                        <h6>1st Place Faculty Choice Capstone</h6>
                        <h6>“Neuroevolution of Augmenting Topologies and Machine Learning – Finite Solution Spaces”</h6>
                        <h6>Virginia Tech Computer Science Undergraduate Research Symposium 2016</h6>
                    </div>
                </div>

                <ul class="collapsible" data-collapsible="accordion">
                    <li>
                        <div class="collapsible-header"><i class="material-icons">info_outline</i>What is this?<i class="material-icons right">import_export</i></div>
                        <div class="collapsible-body">
                            <span>
                                I worked with a team of four CS majors to integrate a machine learning genetic algorithm called NEAT with our AI such that it learn to play Connect Four.
                                While I had fun implementing Connect Four, the focus was on experimenting with different machine learning algorithms.
                                I added multi-threaded support to accelerate the species competition, mutations, and crossover process. As a result, we had an AI that was a master at Connect Four.
                                I utilized AWS as the on-demand, scalable compute cloud resource to execute the machine learning evolution process.
                                My project won first place in the Capstone Awards caption.
                            </span>
                            <span>
                                To learn more about my project, visit the Virginia Tech Undergraduate Research Symposium <a href="http://www.vturcs.cs.vt.edu/spring16.php">here.</a>
                            </span>
                            <ul>
                                <br>
                                <ul>
                                    <li>
                                        <div class="chip blue white-text z-depth-2">Java</div>
                                        <div class="chip blue white-text z-depth-2">Multi-threading</div>
                                        <div class="chip blue white-text z-depth-2">Bash/Shell Scripting</div>
                                        <div class="chip blue white-text z-depth-2">Linux</div>
                                        <div class="chip blue white-text z-depth-2">AWS</div>
                                        <div class="chip blue white-text z-depth-2">Machine Learning</div>
                                        <div class="chip blue white-text z-depth-2">Game design</div>
                                    </li>
                                </ul>
                            </ul>
                            <br>
            ...
            <div class="col s12 m6">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <h6>Virginia Polytechnic Institute and State University</h6>
                        <h6>Blacksburg, VA</h6>
                        <h6>August 2013 - May 2016</h6>
                        <br>
                        <h6>Virginia Commonwealth Governor's School</h6>
                        <h6>Spotsylvania, VA</h6>
                        <h6>August 2009 - June 2013</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section container" id="cert">
        <div class="row">
            <div class="col s12 m12">
                <h3 class="header">Certifications</h3>
                <table class="bordered white z-depth-3">
                    <tbody>
                        <tr>
                            <td>
                                <h6>Information Storage Associate Version 2 (EMCISA)</h6>
                                <h6>July 2015, License GR3BS4ERK1VQQX80</h6>
                                <br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h6>IT Essentials: PC Hardware and Software Course Completion</h6>
                                <h6>May 2013</h6>
                                <br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h6>CompTIA Network+ Certification N10-006</h6>
                                <h6>August 2016 - August 2019, License KD1RK0Y33CQ4YRF9</h6>
                                <br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h6>CompTIA A+ Certification 701-702</h6>
                                <h6>August 2013 - August 2016, License 0VMHLW1B5DQESFWZ</h6>
                                <br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h6>Microsoft Office Specialist (MOS) - Master</h6>
                                <h6>License Master (wbnBV-w7e7), includes Word, Excel, PowerPoint, Access, and Outlook
                                    2007</h6>
                                <br>
                            </td>
                        </tr>
    ...
    <a class="waves-effect waves-light btn indigo right z-depth-3" href="#modal1" >Contact me now!</a>
</div>
